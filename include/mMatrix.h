...
class Matrix22 {
   public:
    ...
    Matrix22() : m11(1), m12(0), m21(0), m22(1) {};

    Matrix22(SCALAR _m11, SCALAR _m12, SCALAR _m21, SCALAR _m22) {
        m11 = _m11;
        m12 = _m12;
        m21 = _m21;
        m22 = _m22;
    ...
    mVector2<SCALAR> TransformNormal(mVector2<SCALAR> p) {
        return mVector2<SCALAR>(m11 * p.x + m12 * p.y, m21 * p.x + m22 * p.y);
    }
    ...
    Matrix22<SCALAR> operator+=(Matrix22<SCALAR> m) { return (*this) = (*this) + m; }
    Matrix22<SCALAR> operator-=(Matrix22<SCALAR> m) { return (*this) = (*this) - m; }
    Matrix22<SCALAR> operator*=(Matrix22<SCALAR> m) { return (*this) = (*this) * m; }
    ...
    Matrix22<SCALAR> operator*=(SCALAR s) { return (*this) = (*this) * s; }
    Matrix22<SCALAR> operator/=(SCALAR s) { return (*this) = (*this) / s; }

    friend ostream& operator<<(ostream& os, Matrix22<SCALAR>& m) {
        return os << m.m11 << " " << m.m12 << endl << m.m21 << " " << m.m22 << endl;
    }

    friend istream& operator>>(istream& is, Matrix22<SCALAR>& m) {
        return is >> m.m11 >> m.m12 >> m.m21 >> m.m22;
    }
...
class Matrix33 {
   public:
    ...
    Matrix33() : m11(1), m12(0), m13(0), m21(0), m22(1), m23(0), m31(0), m32(0), m33(1) {};

    Matrix33(SCALAR _m11, SCALAR _m12, SCALAR _m13, SCALAR _m21, SCALAR _m22, SCALAR _m23,
    ...
    mVector2<SCALAR> TransformCoordinate(mVector2<SCALAR> p) {
        return mVector2<SCALAR>(m11 * p.x + m12 * p.y + m13, m21 * p.x + m22 * p.y + m23);
    }
    ...
    mVector3<SCALAR> TransformCoordinate(mVector3<SCALAR> p) {
        return mVector3<SCALAR>(m11 * p.x + m12 * p.y + m13 * p.z,
    ...
    mVector3<SCALAR> operator*(mVector3<SCALAR> v1) const {
        return mVector3<SCALAR>(m11 * v1.x + m12 * v1.y + m13 * v1.z,
                                m21 * v1.x + m22 * v1.y + m23 * v1.z,
                                m31 * v1.x + m32 * v1.y + m33 * v1.z);
    }

    Matrix33<SCALAR> operator+=(Matrix33<SCALAR> m) { return (*this) = (*this) + m; }
    Matrix33<SCALAR> operator-=(Matrix33<SCALAR> m) { return (*this) = (*this) - m; }
    Matrix33<SCALAR> operator*=(Matrix33<SCALAR> m) { return (*this) = (*this) * m; }
    ...
    Matrix33<SCALAR> operator*=(SCALAR s) { return (*this) = (*this) * s; }
    Matrix33<SCALAR> operator/=(SCALAR s) { return (*this) = (*this) / s; }
    ...
    friend istream& operator>>(istream& is, Matrix33<SCALAR>& m) {
        return is >> m.m11 >> m.m12 >> m.m13 >> m.m21 >> m.m22 >> m.m23 >> m.m31 >> m.m32 >> m.m33;
    }
    ...
    void RotationAxis_twoframe(mVector3<SCALAR> Au, mVector3<SCALAR> Av, mVector3<SCALAR> Bu,
                               mVector3<SCALAR> Bv);
    ...
    static void RotationAxis(Matrix33<SCALAR>* m1, SCALAR sin, SCALAR cos, SCALAR x, SCALAR y,
                             SCALAR z);
...
template <class SCALAR>
void Matrix33<SCALAR>::RotationAxis_twoframe(mVector3<SCALAR> Au, mVector3<SCALAR> Av,
                                             mVector3<SCALAR> Bu, mVector3<SCALAR> Bv) {
    Matrix33<SCALAR> R1;
    Matrix33<SCALAR> R2;
...
template <class SCALAR>
void Matrix33<SCALAR>::RotationAxis(Matrix33<SCALAR>* m1, SCALAR angle, SCALAR x, SCALAR y,
                                    SCALAR z) {
    RotationAxis(m1, sin(angle), cos(angle), x, y, z);
}

template <class SCALAR>
void Matrix33<SCALAR>::RotationAxis(Matrix33<SCALAR>* m1, SCALAR sin, SCALAR cos, SCALAR x,
                                    SCALAR y, SCALAR z) {
    m1->m11 = 1 + (1 - cos) * (x * x - 1);
    m1->m12 = -z * sin + (1 - cos) * x * y;
    m1->m13 = y * sin + (1 - cos) * x * z;
    m1->m21 = z * sin + (1 - cos) * x * y;
    m1->m22 = 1 + (1 - cos) * (y * y - 1);
    m1->m23 = -x * sin + (1 - cos) * y * z;
    m1->m31 = -y * sin + (1 - cos) * x * z;
    m1->m32 = x * sin + (1 - cos) * y * z;
    m1->m33 = 1 + (1 - cos) * (z * z - 1);
}
...
class Matrix44 {
   public:
    ...
    Matrix44(SCALAR _m11, SCALAR _m12, SCALAR _m13, SCALAR _m14, SCALAR _m21, SCALAR _m22,
             SCALAR _m23, SCALAR _m24, SCALAR _m31, SCALAR _m32, SCALAR _m33, SCALAR _m34,
    ...
    mVector3<SCALAR> TransformCoordinate(mVector3<SCALAR> p) {
        return mVector3<SCALAR>(m11 * p.x + m12 * p.y + m13 * p.z + m14,
    ...
    Matrix44<SCALAR> operator+=(Matrix44<SCALAR> m) { return (*this) = (*this) + m; }
    Matrix44<SCALAR> operator-=(Matrix44<SCALAR> m) { return (*this) = (*this) - m; }
    Matrix44<SCALAR> operator*=(Matrix44<SCALAR> m) { return (*this) = (*this) * m; }
    ...
    Matrix44<SCALAR> operator*=(SCALAR s) { return (*this) = (*this) * s; }
    Matrix44<SCALAR> operator/=(SCALAR s) { return (*this) = (*this) / s; }
    ...
    friend istream& operator>>(istream& is, Matrix44<SCALAR>& m) {
        return is >> m.m11 >> m.m12 >> m.m13 >> m.m14 >> m.m21 >> m.m22 >> m.m23 >> m.m24 >>
    ...
    static void RotationAxis(Matrix44<SCALAR>* m1, SCALAR sin, SCALAR cos, SCALAR x, SCALAR y,
                             SCALAR z);
    ...
    static void PerspectiveFovLH(Matrix44<SCALAR>* mat, SCALAR fieldOfViewY, SCALAR aspectRatio,
                                 SCALAR znearPlane, SCALAR zfarPlane);
    static void PerspectiveFovRH(Matrix44<SCALAR>* mat, SCALAR fieldOfViewY, SCALAR aspectRatio,
                                 SCALAR znearPlane, SCALAR zfarPlane);
    static void PerspectiveFovXYLH(Matrix44<SCALAR>* mat, SCALAR fieldOfViewY, SCALAR fieldOfViewX,
                                   SCALAR znearPlane, SCALAR zfarPlane);
    static void PerspectiveFovXYRH(Matrix44<SCALAR>* mat, SCALAR fieldOfViewY, SCALAR fieldOfViewX,
                                   SCALAR znearPlane, SCALAR zfarPlane);
    static void PerspectiveLH(Matrix44<SCALAR>* mat, SCALAR width, SCALAR height, SCALAR znearPlane,
                              SCALAR zfarPlane);
    static void PerspectiveRH(Matrix44<SCALAR>* mat, SCALAR width, SCALAR height, SCALAR znearPlane,
                              SCALAR zfarPlane);
    static void PerspectiveOffCenterLH(Matrix44<SCALAR>* mat, SCALAR left, SCALAR right,
                                       SCALAR bottom, SCALAR top, SCALAR znearPlane,
                                       SCALAR zfarPlane);
    static void PerspectiveOffCenterRH(Matrix44<SCALAR>* mat, SCALAR left, SCALAR right,
                                       SCALAR bottom, SCALAR top, SCALAR znearPlane,
                                       SCALAR zfarPlane);
    static void OrthoLH(Matrix44<SCALAR>* mat, SCALAR width, SCALAR height, SCALAR znearPlane,
                        SCALAR zfarPlane);
    static void OrthoRH(Matrix44<SCALAR>* mat, SCALAR width, SCALAR height, SCALAR znearPlane,
                        SCALAR zfarPlane);
    static void OrthoOffCenterLH(Matrix44<SCALAR>* mat, SCALAR left, SCALAR right, SCALAR bottom,
                                 SCALAR top, SCALAR znearPlane, SCALAR zfarPlane);
    static void OrthoOffCenterRH(Matrix44<SCALAR>* mat, SCALAR left, SCALAR right, SCALAR bottom,
                                 SCALAR top, SCALAR znearPlane, SCALAR zfarPlane);
    static void LookAtLH(Matrix44<SCALAR>* mat, mVector3<SCALAR> cameraPosition,
                         mVector3<SCALAR> cameraTarget, mVector3<SCALAR> cameraUpVector);
    static void LookAtRH(Matrix44<SCALAR>* mat, mVector3<SCALAR> cameraPosition,
                         mVector3<SCALAR> cameraTarget, mVector3<SCALAR> cameraUpVector);
};
...
void Matrix44<SCALAR>::Rotation(Matrix44<SCALAR>* m1, SCALAR angleX, SCALAR angleY, SCALAR angleZ) {
    ...
    m1->m11 = cb * cg;
    m1->m12 = cg * sa * sb - ca * sg;
    m1->m13 = sa * sg + ca * cg * sb;
    m1->m14 = 0;
    m1->m21 = cb * sg;
    m1->m22 = sa * sb * sg + ca * cg;
    m1->m23 = ca * sb * sg - cg * sa;
    m1->m24 = 0;
    m1->m31 = -sb;
    m1->m32 = cb * sa;
    m1->m33 = ca * cb;
...
template <class SCALAR>
void Matrix44<SCALAR>::RotationAxis(Matrix44<SCALAR>* m1, SCALAR angle, SCALAR x, SCALAR y,
                                    SCALAR z) {
    RotationAxis(m1, sin(angle), cos(angle), x, y, z);
}

template <class SCALAR>
void Matrix44<SCALAR>::RotationAxis(Matrix44<SCALAR>* m1, SCALAR sin, SCALAR cos, SCALAR x,
                                    SCALAR y, SCALAR z) {
    m1->m11 = 1 + (1 - cos) * (x * x - 1);
    m1->m12 = -z * sin + (1 - cos) * x * y;
    m1->m13 = y * sin + (1 - cos) * x * z;
...
SCALAR Matrix44<SCALAR>::Determinant(const Matrix44<SCALAR>* m) {
    return m->m11 * m->m22 * m->m33 * m->m44 - m->m11 * m->m22 * m->m34 * m->m43 -
...
void Matrix44<SCALAR>::Adjoint(Matrix44<SCALAR>* result, const Matrix44<SCALAR>* m) {
    result->m11 = m->m22 * m->m33 * m->m44 - m->m22 * m->m34 * m->m43 - m->m32 * m->m23 * m->m44 +
                  m->m32 * m->m24 * m->m43 + m->m42 * m->m23 * m->m34 - m->m42 * m->m24 * m->m33;
    result->m12 = -m->m12 * m->m33 * m->m44 + m->m12 * m->m34 * m->m43 + m->m32 * m->m13 * m->m44 -
                  m->m32 * m->m14 * m->m43 - m->m42 * m->m13 * m->m34 + m->m42 * m->m14 * m->m33;
    result->m13 = m->m12 * m->m23 * m->m44 - m->m12 * m->m24 * m->m43 - m->m22 * m->m13 * m->m44 +
                  m->m22 * m->m14 * m->m43 + m->m42 * m->m13 * m->m24 - m->m42 * m->m14 * m->m23;
    result->m14 = -m->m12 * m->m23 * m->m34 + m->m12 * m->m24 * m->m33 + m->m22 * m->m13 * m->m34 -
                  m->m22 * m->m14 * m->m33 - m->m32 * m->m13 * m->m24 + m->m32 * m->m14 * m->m23;

    result->m21 = -m->m21 * m->m33 * m->m44 + m->m21 * m->m34 * m->m43 + m->m31 * m->m23 * m->m44 -
                  m->m31 * m->m24 * m->m43 - m->m41 * m->m23 * m->m34 + m->m41 * m->m24 * m->m33;
    result->m22 = m->m11 * m->m33 * m->m44 - m->m11 * m->m34 * m->m43 - m->m31 * m->m13 * m->m44 +
                  m->m31 * m->m14 * m->m43 + m->m41 * m->m13 * m->m34 - m->m41 * m->m14 * m->m33;
    result->m23 = -m->m11 * m->m23 * m->m44 + m->m11 * m->m24 * m->m43 + m->m21 * m->m13 * m->m44 -
                  m->m21 * m->m14 * m->m43 - m->m41 * m->m13 * m->m24 + m->m41 * m->m14 * m->m23;
    result->m24 = m->m11 * m->m23 * m->m34 - m->m11 * m->m24 * m->m33 - m->m21 * m->m13 * m->m34 +
                  m->m21 * m->m14 * m->m33 + m->m31 * m->m13 * m->m24 - m->m31 * m->m14 * m->m23;

    result->m31 = m->m21 * m->m32 * m->m44 - m->m21 * m->m34 * m->m42 - m->m31 * m->m22 * m->m44 +
                  m->m31 * m->m24 * m->m42 + m->m41 * m->m22 * m->m34 - m->m41 * m->m24 * m->m32;
    result->m32 = -m->m11 * m->m32 * m->m44 + m->m11 * m->m34 * m->m42 + m->m31 * m->m12 * m->m44 -
                  m->m31 * m->m14 * m->m42 - m->m41 * m->m12 * m->m34 + m->m41 * m->m14 * m->m32;
    result->m33 = m->m11 * m->m22 * m->m44 - m->m11 * m->m24 * m->m42 - m->m21 * m->m12 * m->m44 +
                  m->m21 * m->m14 * m->m42 + m->m41 * m->m12 * m->m24 - m->m41 * m->m14 * m->m22;
    result->m34 = -m->m11 * m->m22 * m->m34 + m->m11 * m->m24 * m->m32 + m->m21 * m->m12 * m->m34 -
                  m->m21 * m->m14 * m->m32 - m->m31 * m->m12 * m->m24 + m->m31 * m->m14 * m->m22;

    result->m41 = -m->m21 * m->m32 * m->m43 + m->m21 * m->m33 * m->m42 + m->m31 * m->m22 * m->m43 -
                  m->m31 * m->m23 * m->m42 - m->m41 * m->m22 * m->m33 + m->m41 * m->m23 * m->m32;
    result->m42 = m->m11 * m->m32 * m->m43 - m->m11 * m->m33 * m->m42 - m->m31 * m->m12 * m->m43 +
                  m->m31 * m->m13 * m->m42 + m->m41 * m->m12 * m->m33 - m->m41 * m->m13 * m->m32;
    result->m43 = -m->m11 * m->m22 * m->m43 + m->m11 * m->m23 * m->m42 + m->m21 * m->m12 * m->m43 -
                  m->m21 * m->m13 * m->m42 - m->m41 * m->m12 * m->m23 + m->m41 * m->m13 * m->m22;
    result->m44 = m->m11 * m->m22 * m->m33 - m->m11 * m->m23 * m->m32 - m->m21 * m->m12 * m->m33 +
...
template <class SCALAR>
void Matrix44<SCALAR>::PerspectiveFovLH(Matrix44<SCALAR>* mat, SCALAR fieldOfViewY,
                                        SCALAR aspectRatio, SCALAR znearPlane, SCALAR zfarPlane) {
    ...
    mat->m31 = 0;
    mat->m32 = 0;
    mat->m33 = zfarPlane / (zfarPlane - znearPlane);
    mat->m34 = -znearPlane * zfarPlane / (zfarPlane - znearPlane);
    mat->m41 = 0;
    mat->m42 = 0;
    mat->m43 = 1;
    mat->m44 = 0;
...
template <class SCALAR>
void Matrix44<SCALAR>::PerspectiveFovRH(Matrix44<SCALAR>* mat, SCALAR fieldOfViewY,
                                        SCALAR aspectRatio, SCALAR znearPlane, SCALAR zfarPlane) {
    SCALAR h = 1.0f / (SCALAR)tan(fieldOfViewY / 2);
    SCALAR w = h / aspectRatio;
    ...
    mat->m31 = 0;
    mat->m32 = 0;
    mat->m33 = zfarPlane / (znearPlane - zfarPlane);
    mat->m34 = znearPlane * zfarPlane / (znearPlane - zfarPlane);
    mat->m41 = 0;
    mat->m42 = 0;
    mat->m43 = -1;
    mat->m44 = 0;
...
template <class SCALAR>
void Matrix44<SCALAR>::PerspectiveFovXYLH(Matrix44<SCALAR>* mat, SCALAR fieldOfViewY,
                                          SCALAR fieldOfViewX, SCALAR znearPlane,
                                          SCALAR zfarPlane) {
    SCALAR h = 1.0f / (SCALAR)tan(fieldOfViewY / 2);
...
template <class SCALAR>
void Matrix44<SCALAR>::PerspectiveFovXYRH(Matrix44<SCALAR>* mat, SCALAR fieldOfViewY,
                                          SCALAR fieldOfViewX, SCALAR znearPlane,
                                          SCALAR zfarPlane) {
    SCALAR h = 1.0f / (SCALAR)tan(fieldOfViewY / 2);
    SCALAR w = 1.0f / (SCALAR)tan(fieldOfViewX / 2);
...
template <class SCALAR>
void Matrix44<SCALAR>::PerspectiveLH(Matrix44<SCALAR>* mat, SCALAR width, SCALAR height,
                                     SCALAR znearPlane, SCALAR zfarPlane) {
    mat->m11 = 2 * znearPlane / width;
    mat->m12 = 0;
    mat->m13 = 0;
    mat->m14 = 0;
    mat->m21 = 0;
    mat->m22 = 2 * znearPlane / height;
    mat->m23 = 0;
    mat->m24 = 0;
    mat->m31 = 0;
    mat->m32 = 0;
...
template <class SCALAR>
void Matrix44<SCALAR>::PerspectiveRH(Matrix44<SCALAR>* mat, SCALAR width, SCALAR height,
                                     SCALAR znearPlane, SCALAR zfarPlane) {
    mat->m11 = 2 * znearPlane / width;
    mat->m12 = 0;
    mat->m13 = 0;
...
template <class SCALAR>
void Matrix44<SCALAR>::PerspectiveOffCenterLH(Matrix44<SCALAR>* mat, SCALAR left, SCALAR right,
                                              SCALAR bottom, SCALAR top, SCALAR znearPlane,
                                              SCALAR zfarPlane) {
    mat->m11 = 2 * znearPlane / (right - left);
    mat->m12 = 0;
    mat->m13 = (left + right) / (left - right);
    mat->m14 = 0;
    mat->m21 = 0;
    mat->m22 = 2 * znearPlane / (top - bottom);
    mat->m23 = (top + bottom) / (bottom - top);
    mat->m24 = 0;
    mat->m31 = 0;
    mat->m32 = 0;
    mat->m33 = zfarPlane / (zfarPlane - znearPlane);
...
template <class SCALAR>
void Matrix44<SCALAR>::PerspectiveOffCenterRH(Matrix44<SCALAR>* mat, SCALAR left, SCALAR right,
                                              SCALAR bottom, SCALAR top, SCALAR znearPlane,
                                              SCALAR zfarPlane) {
    mat->m11 = 2 * znearPlane / (right - left);
    mat->m12 = 0;
    mat->m13 = (left + right) / (right - left);
    mat->m14 = 0;
    mat->m21 = 0;
    mat->m22 = 2 * znearPlane / (top - bottom);
...
template <class SCALAR>
void Matrix44<SCALAR>::OrthoLH(Matrix44<SCALAR>* mat, SCALAR width, SCALAR height,
                               SCALAR znearPlane, SCALAR zfarPlane) {
    mat->m11 = 2 / width;
    mat->m12 = 0;
    mat->m13 = 0;
    ...
    mat->m31 = 0;
    mat->m32 = 0;
    mat->m33 = 1 / (zfarPlane - znearPlane);
    mat->m34 = znearPlane / (znearPlane - zfarPlane);
    mat->m41 = 0;
    mat->m42 = 0;
    mat->m43 = 0;
    mat->m44 = 1;
...
template <class SCALAR>
void Matrix44<SCALAR>::OrthoRH(Matrix44<SCALAR>* mat, SCALAR width, SCALAR height,
                               SCALAR znearPlane, SCALAR zfarPlane) {
    mat->m11 = 2 / width;
    mat->m12 = 0;
    mat->m13 = 0;
    ...
    mat->m31 = 0;
    mat->m32 = 0;
    mat->m33 = 1 / (znearPlane - zfarPlane);
    mat->m34 = znearPlane / (znearPlane - zfarPlane);
    mat->m41 = 0;
    mat->m42 = 0;
    mat->m43 = 0;
...
template <class SCALAR>
void Matrix44<SCALAR>::OrthoOffCenterLH(Matrix44<SCALAR>* mat, SCALAR left, SCALAR right,
                                        SCALAR bottom, SCALAR top, SCALAR znearPlane,
                                        SCALAR zfarPlane) {
    mat->m11 = 2 / (right - left);
    mat->m12 = 0;
    mat->m13 = 0;
    mat->m14 = (left + right) / (left - right);
    mat->m21 = 0;
    mat->m22 = 2 / (top - bottom);
    mat->m23 = 0;
    mat->m24 = (top + bottom) / (bottom - top);
    mat->m31 = 0;
    mat->m32 = 0;
    mat->m33 = 1 / (zfarPlane - znearPlane);
    mat->m34 = znearPlane / (znearPlane - zfarPlane);
...
template <class SCALAR>
void Matrix44<SCALAR>::OrthoOffCenterRH(Matrix44<SCALAR>* mat, SCALAR left, SCALAR right,
                                        SCALAR bottom, SCALAR top, SCALAR znearPlane,
                                        SCALAR zfarPlane) {
    mat->m11 = 2 / (right - left);
    mat->m12 = 0;
    mat->m13 = 0;
    mat->m14 = (left + right) / (right - left);
    mat->m21 = 0;
    mat->m22 = 2 / (top - bottom);
    mat->m23 = 0;
...
template <class SCALAR>
void Matrix44<SCALAR>::LookAtLH(Matrix44<SCALAR>* mat, mVector3<SCALAR> cameraPosition,
                                mVector3<SCALAR> cameraTarget, mVector3<SCALAR> cameraUpVector) {
    ...
    mat->m12 = xaxis.y;
    mat->m13 = xaxis.z;
    mat->m14 = -(cameraPosition ^ xaxis);
    mat->m21 = yaxis.x;
    mat->m22 = yaxis.y;
    mat->m23 = yaxis.z;
    mat->m24 = -(cameraPosition ^ yaxis);
    mat->m31 = zaxis.x;
    mat->m32 = zaxis.y;
    mat->m33 = zaxis.z;
    mat->m34 = -(cameraPosition ^ zaxis);
    mat->m41 = 0;
    mat->m42 = 0;
    mat->m43 = 0;
    mat->m44 = 1;
...
template <class SCALAR>
void Matrix44<SCALAR>::LookAtRH(Matrix44<SCALAR>* mat, mVector3<SCALAR> cameraPosition,
                                mVector3<SCALAR> cameraTarget, mVector3<SCALAR> cameraUpVector) {
